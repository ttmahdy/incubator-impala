...
#define QUERY_OPTS_TABLE\
  DCHECK_EQ(_TImpalaQueryOptions_VALUES_TO_NAMES.size(),\
      TImpalaQueryOptions::MAX_QUERY_FRAGMENTS + 1);\
  ...
  QUERY_OPT_FN(reject_query_missing_estimates, REJECT_QUERY_MISSING_ESTIMATES)\
  QUERY_OPT_FN(max_query_fragments, MAX_QUERY_FRAGMENTS)\
  ;
