...
class RuntimeState {
 public:
  ...
  const cctz::time_zone* local_time_zone() const { return local_time_zone_; }
 ...
 private:
  ...
  /// Query-global timezone used as local timezone when executing the query. Use pointer
  /// to avoid inclusion of cctz/time_zone.h.
  const cctz::time_zone* local_time_zone_;
